...
/obj/item/grenade/proc/botch_check(mob/living/carbon/human/user)
	...
	if(clumsy && (clumsy_check == GRENADE_CLUMSY_FUMBLE))
		...
		to_chat(user, "<span class='warning'>You pull the pin on [src]. Attached to it is a pink ribbon that says, \"<span class='clowntext'>HONK</span>\"</span>")
		preprime(user, 5, FALSE)
		return TRUE
...
/obj/item/grenade/examine(mob/user)
	...
	if (dud_flags & GRENADE_USED)
		. += "<span class='warning'>It looks like [p_theyve()] already been used.</span>"
...
<<<<<<< HEAD:code/game/objects/items/grenades/grenade.dm
...
>>>>>>> 5ef54794c8... Makes used grenades slightly more obvious. Also prevents DOSing admins. (#6321):code/game/objects/items/grenades/_grenade.dm
